...
public class PayPsdInputView extends android.support.v7.widget.AppCompatEditText {
     ...
     * 圆的颜色   默认BLACK
     */
    private int circleColor = Color.parseColor("#E94E46");
    /**
     * 底部线的颜色   默认GRAY
     */
    private int bottomLineColor = Color.parseColor("#D9D9D9");
     ...
     * 竖直分割线的颜色
     */
    private int divideLineColor =  Color.parseColor("#D9D9D9");
    private int focusedColor =  Color.parseColor("#E94E46");
