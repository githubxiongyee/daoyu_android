 ...
 * 开启定位dialog
 */
public class DeleteAddressDialog extends DialogFragment implements View.OnClickListener {
    ...
    public static DeleteAddressDialog getInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View inflate = inflater.inflate(R.layout.dialog_delete_address, container, false);
