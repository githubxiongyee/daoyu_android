...
//生活类
public class LifeActivity extends BaseTitleActivity implements LifeAdapter.OnItemClickListener, SingleChooseLabelDialog.IChooseLabelType, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.iv_right:
                ...
                intent.putExtra(Constant.CONTACT_LABEL, "life");
    ...
    public void onChooseLabel(String label) {
        ...
        requestUpdateLabel("J", currentContact);
    }
